...
#define arena_dealloc 	dkt_arena_dealloc
...
extern void dkt_arena_free( DktArena *arena);
 ...
 */
extern void dkt_arena_dealloc( DktArena *arena, void* ptr);
...
void dkt_arena_free( DktArena *arena) {
	if (!arena) return;
